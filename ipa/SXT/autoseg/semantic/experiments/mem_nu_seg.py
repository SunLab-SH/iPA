...
from experiments.parser_nc import args
...
# num_classes = 2
# checkpoint_dir = f'F:/salilab/salilab/projects/auto-segmentation_Aneesh/fromgit/Cell-Segmentation/results/FS_mem_nu/best.pth'
...
class cellmapping_test():
    def __init__(self, type='imageall_x'):
        ...
        self.checkpoint_dir =  'F:/salilab/salilab/projects/auto-segmentation_Aneesh/fromgit/Cell-Segmentation/results/FS_mem_nu/best.pth' # 'results/{}/best.pth'.format(args.exp)
        ...
        with open(os.path.join(args.data_root_dir, 'dataid2_seg.txt'), 'r') as f1:
    ...
    def save_tiff(self, pred, imagefile):
        # imagefile = imageid
        savepath = f'{args.root_dir}//results//masks//{self.type}_mem_nu_predtiff'
    ...
    def test(self):
        ...
        print('Resume from {}'.format(self.checkpoint_dir))  # results/FS_mem_nu/best.pth
        ...
        for dataid in self.data_idxs:
            ...
            # pred_mask = tifffile.imread(f'F:\\salilab\\salilab\\projects\\auto-segmentation_Aneesh\\autoseg\\semantic\\results\\masks\\imageall_x_mem_nu_predtiff\\GIP_30_1535.tiff')
...
class Post_process(cellmapping_test):
    ...
    def save_tiff_coarse(self, pred, imagefile):
        ...
        make_dir(savepath)
        tifffile.imsave(f'{savepath}/{imagefile}_pred.tiff', np.array(pred))
        print(f"save {savepath}/{imagefile}.tiff'")
    ...
    def post_fusexyz(self):
        for imagefile in self.data_idxs:
            ...
            f'{args.root_dir}//results//masks//{self.type}_mem_nu_predtiff'
