...
def dist2fila_condition_plot(actin_vect_map_condition, condition, validpath):
    ...
    grid_z0[np.where(grid_z0 < (np.max(grid_z0) * 0.01) )] = np.nan
    # grid_z0[np.where(grid_z0 < (np.max(grid_z0) * 0.3) )] = 0
...
def dist_fila2MT_condition_plot(actin_vect_map_condition, condition, validpath):
    ...
    # grid_z0[np.where(grid_z0 < (np.max(grid_z0) * 0.015) )] = np.nan
    # grid_z0[np.where(grid_z0 < (np.max(grid_z0) * 0.2) )] = 0
