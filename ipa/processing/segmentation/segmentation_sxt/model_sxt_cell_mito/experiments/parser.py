...
args = parser.parse_args(args=base_args)


args_nu_list = base_args + ['--exp', "FS_mem_nu"] + ['--mode', 'mem_nu']
args_nu = parser.parse_args(args=args_nu_list)

args_mito_list = base_args + ['--exp', "FS_mito"] + ['--mode', 'mito']
args_mito = parser.parse_args(args=args_mito_list)
