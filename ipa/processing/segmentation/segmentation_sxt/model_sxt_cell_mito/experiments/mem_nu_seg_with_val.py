...
from experiments.parser import args_nu as args
    ...
    def get_filelist(self, dir, Filelist):
        ...
        if os.path.isfile(dir):
            ...
            for s in os.listdir(dir):
                # If need to ignore certain folders, use the following code
                #if s == "xxx":
                    #continue
...
class cellmapping_test():
    def __init__(self, type='imageall_x', dataid=None, pool=None, image_data=None):
        ...
        self.checkpoint_dir =  'data/unet_pth/best.pth' # 'results/{}/best.pth'.format(args.exp)
        ...
        self.pool = pool
        self.image_data = image_data  # Preloaded image data
    ...
    def test(self):
        ...
        for dataid in self.data_idxs:
            ...
            if self.image_data is not None and dataid in self.image_data:
                ...
                # If no preloaded data, fallback to original loading method
            ...
            # Process 3D image rotation based on view type
...
def run_cell_segmentation(data_root_dir=None, model_path=None, save_dir=None, 
                    gpu='0', mode='nucleus', 
                    num_classes=2, 
    ...
    This function performs deep learning-based segmentation of cellular structures (nucleus, membrane, etc.)
    ...
    Args:
        ...
        mode (str, optional): Segmentation target mode. Defaults to 'nucleus'.
            Options: 'nucleus', 'membrane', 'mem_nu' (combined).
    ...
    model_path = f'{parent_dir}/models/nu_best.pth'
    ...
    if image_data:
        print(f"Using preloaded image data, data IDs: {list(image_data.keys())}")
    else:
...
#     model_path = f'{mainpath}/data/unet_pth/nu_best.pth'
#     save_dir = f'{mainpath}/results/mem_nu_seg_with_val'

#     # Use preloaded data for segmentation
...
#         pool_processes=6,
#         dataid=dataid_list,
#         image_data=image_data  # Pass preloaded image data
#     )
