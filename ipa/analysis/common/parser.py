...
## load data
parser.add_argument('--root-dir', type=str, default='F:\\Salilab\\Projects\\filament_project_weimin\\data', help='root for all files')
...
parser.add_argument('--fa-raw-data-dir', type=str, default=f'F:\\Salilab\\Projects\\filament_project_weimin\\data\\folcon\\FA', help='raw data root facal adhesion data' )
parser.add_argument('--ca-raw-data-dir', type=str, default=f'F:\\Salilab\\Projects\\filament_project_weimin\\data\\folcon\\Ca', help='raw data root calcium data' )
# F:\Salilab\Projects\filament_project_weimin
# processed data
