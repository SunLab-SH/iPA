...
def coords_to_mem_distance_angle_pair_generator(filament_coords, filament_angle_data, mask, voxelsize):
    ...
    # anglelabel_mask = np.zeros_like(mask) 
    # for idxx, angle in enumerate(angle_lst):
    #     anglelabel_mask[int(voxel_coords[idxx][0])][int(voxel_coords[idxx][1])][int(voxel_coords[idxx][2])] = angle
