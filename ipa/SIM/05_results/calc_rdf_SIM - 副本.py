...
#########################################
    ...
    # isgout=open(f'{file_dir}/results/{file_name}_bin2_isgrdf_ne-pm.xvg', 'w') # output
    isgout=open(f'{file_dir}/results/{file_name}_bin2_mtrdf_ne-pm.xvg', 'w') # output
