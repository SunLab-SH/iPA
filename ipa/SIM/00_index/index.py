...
for file in file_list:
    ...
    for tp in range(len(mask_t)):
        ...
        ne_edge=ne_ndx.T
        ne_out = open(root_dir + out_name + '_ne_index' + '_t' + str(tp) + '.xvg', 'w') # output
        ...
        pm_edge=pm_ndx.T 
        pm_out=open(root_dir + out_name + '_pm_index' + '_t' + str(tp) + '.xvg', 'w') # output
